...
const (
	HubService_SubmitMessage_FullMethodName                      = "/farcaster.HubService/SubmitMessage"
	HubService_SubmitBulkMessages_FullMethodName                 = "/farcaster.HubService/SubmitBulkMessages"
	HubService_ValidateMessage_FullMethodName                    = "/farcaster.HubService/ValidateMessage"
	HubService_GetBlocks_FullMethodName                          = "/farcaster.HubService/GetBlocks"
	HubService_GetShardChunks_FullMethodName                     = "/farcaster.HubService/GetShardChunks"
	HubService_GetInfo_FullMethodName                            = "/farcaster.HubService/GetInfo"
	HubService_GetFids_FullMethodName                            = "/farcaster.HubService/GetFids"
	HubService_GetConnectedPeers_FullMethodName                  = "/farcaster.HubService/GetConnectedPeers"
	HubService_Subscribe_FullMethodName                          = "/farcaster.HubService/Subscribe"
	HubService_GetEvent_FullMethodName                           = "/farcaster.HubService/GetEvent"
	HubService_GetEvents_FullMethodName                          = "/farcaster.HubService/GetEvents"
	HubService_GetCast_FullMethodName                            = "/farcaster.HubService/GetCast"
	HubService_GetCastsByFid_FullMethodName                      = "/farcaster.HubService/GetCastsByFid"
	HubService_GetCastsByParent_FullMethodName                   = "/farcaster.HubService/GetCastsByParent"
	HubService_GetCastsByMention_FullMethodName                  = "/farcaster.HubService/GetCastsByMention"
	HubService_GetReaction_FullMethodName                        = "/farcaster.HubService/GetReaction"
	HubService_GetReactionsByFid_FullMethodName                  = "/farcaster.HubService/GetReactionsByFid"
	HubService_GetReactionsByCast_FullMethodName                 = "/farcaster.HubService/GetReactionsByCast"
	HubService_GetReactionsByTarget_FullMethodName               = "/farcaster.HubService/GetReactionsByTarget"
	HubService_GetUserData_FullMethodName                        = "/farcaster.HubService/GetUserData"
	HubService_GetUserDataByFid_FullMethodName                   = "/farcaster.HubService/GetUserDataByFid"
	HubService_GetUsernameProof_FullMethodName                   = "/farcaster.HubService/GetUsernameProof"
	HubService_GetUserNameProofsByFid_FullMethodName             = "/farcaster.HubService/GetUserNameProofsByFid"
	HubService_GetVerification_FullMethodName                    = "/farcaster.HubService/GetVerification"
	HubService_GetVerificationsByFid_FullMethodName              = "/farcaster.HubService/GetVerificationsByFid"
	HubService_GetOnChainSigner_FullMethodName                   = "/farcaster.HubService/GetOnChainSigner"
	HubService_GetOnChainSignersByFid_FullMethodName             = "/farcaster.HubService/GetOnChainSignersByFid"
	HubService_GetOnChainEvents_FullMethodName                   = "/farcaster.HubService/GetOnChainEvents"
	HubService_GetIdRegistryOnChainEvent_FullMethodName          = "/farcaster.HubService/GetIdRegistryOnChainEvent"
	HubService_GetIdRegistryOnChainEventByAddress_FullMethodName = "/farcaster.HubService/GetIdRegistryOnChainEventByAddress"
	HubService_GetCurrentStorageLimitsByFid_FullMethodName       = "/farcaster.HubService/GetCurrentStorageLimitsByFid"
	HubService_GetFidAddressType_FullMethodName                  = "/farcaster.HubService/GetFidAddressType"
	HubService_GetLink_FullMethodName                            = "/farcaster.HubService/GetLink"
	HubService_GetLinksByFid_FullMethodName                      = "/farcaster.HubService/GetLinksByFid"
	HubService_GetLinksByTarget_FullMethodName                   = "/farcaster.HubService/GetLinksByTarget"
	HubService_GetLinkCompactStateMessageByFid_FullMethodName    = "/farcaster.HubService/GetLinkCompactStateMessageByFid"
	HubService_GetAllCastMessagesByFid_FullMethodName            = "/farcaster.HubService/GetAllCastMessagesByFid"
	HubService_GetAllReactionMessagesByFid_FullMethodName        = "/farcaster.HubService/GetAllReactionMessagesByFid"
	HubService_GetAllVerificationMessagesByFid_FullMethodName    = "/farcaster.HubService/GetAllVerificationMessagesByFid"
	HubService_GetAllUserDataMessagesByFid_FullMethodName        = "/farcaster.HubService/GetAllUserDataMessagesByFid"
	HubService_GetAllLinkMessagesByFid_FullMethodName            = "/farcaster.HubService/GetAllLinkMessagesByFid"
	HubService_GetAllLendStorageMessagesByFid_FullMethodName     = "/farcaster.HubService/GetAllLendStorageMessagesByFid"
	HubService_GetTrieMetadataByPrefix_FullMethodName            = "/farcaster.HubService/GetTrieMetadataByPrefix"
)
...
type HubServiceClient interface {
	...
	GetAllLendStorageMessagesByFid(ctx context.Context, in *FidTimestampRequest, opts ...grpc.CallOption) (*MessagesResponse, error)
...
func (c *hubServiceClient) GetConnectedPeers(ctx context.Context, in *GetConnectedPeersRequest, opts ...grpc.CallOption) (*GetConnectedPeersResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetConnectedPeersResponse)
	err := c.cc.Invoke(ctx, HubService_GetConnectedPeers_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *hubServiceClient) GetAllLendStorageMessagesByFid(ctx context.Context, in *FidTimestampRequest, opts ...grpc.CallOption) (*MessagesResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(MessagesResponse)
	err := c.cc.Invoke(ctx, HubService_GetAllLendStorageMessagesByFid_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type HubServiceServer interface {
	...
	GetAllLendStorageMessagesByFid(context.Context, *FidTimestampRequest) (*MessagesResponse, error)
...
func (UnimplementedHubServiceServer) GetConnectedPeers(context.Context, *GetConnectedPeersRequest) (*GetConnectedPeersResponse, error) {
...
func (UnimplementedHubServiceServer) GetAllLendStorageMessagesByFid(context.Context, *FidTimestampRequest) (*MessagesResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetAllLendStorageMessagesByFid not implemented")
}
...
func _HubService_GetConnectedPeers_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetConnectedPeersRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(HubServiceServer).GetConnectedPeers(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: HubService_GetConnectedPeers_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(HubServiceServer).GetConnectedPeers(ctx, req.(*GetConnectedPeersRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _HubService_GetAllLendStorageMessagesByFid_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(FidTimestampRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(HubServiceServer).GetAllLendStorageMessagesByFid(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: HubService_GetAllLendStorageMessagesByFid_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(HubServiceServer).GetAllLendStorageMessagesByFid(ctx, req.(*FidTimestampRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var HubService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "farcaster.HubService",
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _HubService_GetConnectedPeers_Handler,
		},
		{
			MethodName: "GetEvent",
		...
		},
		{
			...
			Handler:    _HubService_GetAllLendStorageMessagesByFid_Handler,
		},
		{
