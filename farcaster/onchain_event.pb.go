...
const (
	...
	OnChainEventType_EVENT_TYPE_TIER_PURCHASE   OnChainEventType = 5
)
...
const (
	TierType_None TierType = 0
	TierType_Pro  TierType = 1
)
...
func (IdRegisterEventType) Descriptor() protoreflect.EnumDescriptor {
	return file_onchain_event_proto_enumTypes[3].Descriptor()
}

func (IdRegisterEventType) Type() protoreflect.EnumType {
	return &file_onchain_event_proto_enumTypes[3]
}
...
type OnChainEvent struct {
	...
	Type            OnChainEventType       `protobuf:"varint,1,opt,name=type,proto3,enum=farcaster.OnChainEventType" json:"type,omitempty"`
	...
	//	*OnChainEvent_TierPurchaseEventBody
...
func (x *OnChainEvent) GetTierPurchaseEventBody() *TierPurchaseBody {
	if x != nil {
		if x, ok := x.Body.(*OnChainEvent_TierPurchaseEventBody); ok {
			return x.TierPurchaseEventBody
		}
	}
	return nil
}
...
type OnChainEvent_TierPurchaseEventBody struct {
	TierPurchaseEventBody *TierPurchaseBody `protobuf:"bytes,15,opt,name=tier_purchase_event_body,json=tierPurchaseEventBody,proto3,oneof"`
}
...
func (*OnChainEvent_TierPurchaseEventBody) isOnChainEvent_Body() {}

type TierPurchaseBody struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	...
	ForDays       uint64                 `protobuf:"varint,2,opt,name=for_days,json=forDays,proto3" json:"for_days,omitempty"`
	Payer         []byte                 `protobuf:"bytes,3,opt,name=payer,proto3" json:"payer,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *TierPurchaseBody) Reset() {
	*x = TierPurchaseBody{}
...
func (x *TierPurchaseBody) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*TierPurchaseBody) ProtoMessage() {}

func (x *TierPurchaseBody) ProtoReflect() protoreflect.Message {
	mi := &file_onchain_event_proto_msgTypes[1]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use TierPurchaseBody.ProtoReflect.Descriptor instead.
func (*TierPurchaseBody) Descriptor() ([]byte, []int) {
	return file_onchain_event_proto_rawDescGZIP(), []int{1}
}

func (x *TierPurchaseBody) GetTierType() TierType {
	if x != nil {
		return x.TierType
	}
...
func (x *TierPurchaseBody) GetForDays() uint64 {
	if x != nil {
		return x.ForDays
	}
	return 0
...
func (x *TierPurchaseBody) GetPayer() []byte {
	if x != nil {
		return x.Payer
	}
	return nil
...
type SignerEventBody struct {
	...
	EventType     SignerEventType        `protobuf:"varint,3,opt,name=event_type,json=eventType,proto3,enum=farcaster.SignerEventType" json:"event_type,omitempty"`
...
type IdRegisterEventBody struct {
	...
	EventType       IdRegisterEventType    `protobuf:"varint,2,opt,name=event_type,json=eventType,proto3,enum=farcaster.IdRegisterEventType" json:"event_type,omitempty"`
...
func (x *StorageRentEventBody) Reset() {
	*x = StorageRentEventBody{}
	mi := &file_onchain_event_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*StorageRentEventBody) Descriptor() ([]byte, []int) {
	return file_onchain_event_proto_rawDescGZIP(), []int{5}
}
...
var file_onchain_event_proto_rawDesc = string([]byte{
	...
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x09, 0x66, 0x61, 0x72, 0x63, 0x61, 0x73, 0x74, 0x65, 0x72,
	0x22, 0x92, 0x06, 0x0a, 0x0c, 0x4f, 0x6e, 0x43, 0x68, 0x61, 0x69, 0x6e, 0x45, 0x76, 0x65, 0x6e,
	0x74, 0x12, 0x2f, 0x0a, 0x04, 0x74, 0x79, 0x70, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0e, 0x32,
	0x1b, 0x2e, 0x66, 0x61, 0x72, 0x63, 0x61, 0x73, 0x74, 0x65, 0x72, 0x2e, 0x4f, 0x6e, 0x43, 0x68,
	0x61, 0x69, 0x6e, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x54, 0x79, 0x70, 0x65, 0x52, 0x04, 0x74, 0x79,
	...
	0x6d, 0x70, 0x18, 0x05, 0x20, 0x01, 0x28, 0x04, 0x52, 0x0e, 0x62, 0x6c, 0x6f, 0x63, 0x6b, 0x54,
	...
	,
	...
	0x65, 0x52, 0x08, 0x74, 0x69, 0x65, 0x72, 0x54, 0x79, 0x70, 0x65, 0x12, 0x19, 0x0a, 0x08, 0x66,
	0x6f, 0x72, 0x5f, 0x64, 0x61, 0x79, 0x73, 0x18, 0x02, 0x20, 0x01, 0x28, 0x04, 0x52, 0x07, 0x66,
	0x6f, 0x72, 0x44, 0x61, 0x79, 0x73, 0x12, 0x14, 0x0a, 0x05, 0x70, 0x61, 0x79, 0x65, 0x72, 0x18,
	0x03, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x05, 0x70, 0x61, 0x79, 0x65, 0x72, 0x22, 0xba, 0x01, 0x0a,
	0x0f, 0x53, 0x69, 0x67, 0x6e, 0x65, 0x72, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x42, 0x6f, 0x64, 0x79,
	...
	,
	...
	0x65, 0x78, 0x70, 0x69, 0x72, 0x79, 0x2a, 0xb5, 0x01, 0x0a, 0x10, 0x4f, 0x6e, 0x43, 0x68, 0x61,
	...
	,
})
...
var file_onchain_event_proto_enumTypes = make([]protoimpl.EnumInfo, 4)
var file_onchain_event_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_onchain_event_proto_goTypes = []any{
	(OnChainEventType)(0),           // 0: farcaster.OnChainEventType
	(TierType)(0),                   // 1: farcaster.TierType
	(SignerEventType)(0),            // 2: farcaster.SignerEventType
	(IdRegisterEventType)(0),        // 3: farcaster.IdRegisterEventType
	(*OnChainEvent)(nil),            // 4: farcaster.OnChainEvent
	(*TierPurchaseBody)(nil),        // 5: farcaster.TierPurchaseBody
	(*SignerEventBody)(nil),         // 6: farcaster.SignerEventBody
	(*SignerMigratedEventBody)(nil), // 7: farcaster.SignerMigratedEventBody
	(*IdRegisterEventBody)(nil),     // 8: farcaster.IdRegisterEventBody
	(*StorageRentEventBody)(nil),    // 9: farcaster.StorageRentEventBody
}
var file_onchain_event_proto_depIdxs = []int32{
	0, // 0: farcaster.OnChainEvent.type:type_name -> farcaster.OnChainEventType
	6, // 1: farcaster.OnChainEvent.signer_event_body:type_name -> farcaster.SignerEventBody
	7, // 2: farcaster.OnChainEvent.signer_migrated_event_body:type_name -> farcaster.SignerMigratedEventBody
	8, // 3: farcaster.OnChainEvent.id_register_event_body:type_name -> farcaster.IdRegisterEventBody
	9, // 4: farcaster.OnChainEvent.storage_rent_event_body:type_name -> farcaster.StorageRentEventBody
	5, // 5: farcaster.OnChainEvent.tier_purchase_event_body:type_name -> farcaster.TierPurchaseBody
	1, // 6: farcaster.TierPurchaseBody.tier_type:type_name -> farcaster.TierType
	2, // 7: farcaster.SignerEventBody.event_type:type_name -> farcaster.SignerEventType
	3, // 8: farcaster.IdRegisterEventBody.event_type:type_name -> farcaster.IdRegisterEventType
...
func file_onchain_event_proto_init() {
	...
	file_onchain_event_proto_msgTypes[0].OneofWrappers = []any{
		...
		(*OnChainEvent_TierPurchaseEventBody)(nil),
	}
	type x struct{}
