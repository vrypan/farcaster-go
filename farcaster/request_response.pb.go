...
var file_request_response_proto_rawDesc = string([]byte{
	...
	0x6b, 0x65, 0x6e, 0x2a, 0xbe, 0x01, 0x0a, 0x09, 0x53, 0x74, 0x6f, 0x72, 0x65, 0x54, 0x79, 0x70,
	...
	0x46, 0x53, 0x10, 0x06, 0x2a, 0x3b, 0x0a, 0x0f, 0x53, 0x74, 0x6f, 0x72, 0x61, 0x67, 0x65, 0x55,
...
var file_request_response_proto_msgTypes = make([]protoimpl.MessageInfo, 42)
var file_request_response_proto_goTypes = []any{
	...
	(*ShardChunk)(nil),                      // 44: ShardChunk
	(HubEventType)(0),                       // 45: HubEventType
	(*Message)(nil),                         // 46: Message
	(*CastId)(nil),                          // 47: CastId
	(ReactionType)(0),                       // 48: ReactionType
	(UserDataType)(0),                       // 49: UserDataType
	(OnChainEventType)(0),                   // 50: OnChainEventType
	(*OnChainEvent)(nil),                    // 51: OnChainEvent
	(TierType)(0),                           // 52: TierType
	(*UserNameProof)(nil),                   // 53: UserNameProof
	(*HubEvent)(nil),                        // 54: HubEvent
}
var file_request_response_proto_depIdxs = []int32{
	44, // 0: ShardChunksResponse.shard_chunks:type_name -> ShardChunk
	45, // 1: SubscribeRequest.event_types:type_name -> HubEventType
	6,  // 2: GetInfoResponse.db_stats:type_name -> DbStats
	7,  // 3: GetInfoResponse.shard_infos:type_name -> ShardInfo
	46, // 4: MessagesResponse.messages:type_name -> Message
	47, // 5: CastsByParentRequest.parent_cast_id:type_name -> CastId
	48, // 6: ReactionRequest.reaction_type:type_name -> ReactionType
	47, // 7: ReactionRequest.target_cast_id:type_name -> CastId
	48, // 8: ReactionsByFidRequest.reaction_type:type_name -> ReactionType
	47, // 9: ReactionsByTargetRequest.target_cast_id:type_name -> CastId
	48, // 10: ReactionsByTargetRequest.reaction_type:type_name -> ReactionType
	49, // 11: UserDataRequest.user_data_type:type_name -> UserDataType
	50, // 12: OnChainEventRequest.event_type:type_name -> OnChainEventType
	51, // 13: OnChainEventResponse.events:type_name -> OnChainEvent
	52, // 14: TierDetails.tier_type:type_name -> TierType
	...
	53, // 20: UsernameProofsResponse.proofs:type_name -> UserNameProof
	46, // 21: ValidationResponse.message:type_name -> Message
	46, // 22: SubmitBulkMessagesRequest.messages:type_name -> Message
	46, // 23: BulkMessageResponse.message:type_name -> Message
	...
	54, // 27: EventsResponse.events:type_name -> HubEvent
